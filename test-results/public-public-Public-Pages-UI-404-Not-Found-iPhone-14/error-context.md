...
- Name: public/public.spec.js >> Public Pages UI >> 404 Not Found
- Location: tests/visual/public/public.spec.js:22:3
...
Call log:
  - navigating to "http://localhost:3000/non-existent-page-for-404-test", waiting until "load"
