...
export async function POST(request) {
    try {
        ...
        const { subjects, chapters, chapter_name, topics, questionCount } = _body;
        ...
        return NextResponse.json({ error: 'Failed to generate PYQ test. Please try again in a moment.' }, { status: 500 });
    }
}
