 ...
 *
 * SYLLABUS VERSION: NCERT_2024_RATIONALIZED
 * Based on NCERT syllabus rationalization (2023-24 academic year, NEP 2020)
 * Chapters are numbered as per the RATIONALIZED book, not the old editions.
 * PDF filenames reflect the new chapter order on ncert.nic.in.
 *
 ...
 *
 * Deleted chapters (do NOT add back without verifying on ncert.nic.in):
 * Chemistry 11: States of Matter, Hydrogen, s-Block, p-Block, Environmental Chemistry
 * Chemistry 12: Solid State, Surface Chemistry, Isolation of Elements, p-Block, Polymers, Everyday Life
 * Biology 11: Transport in Plants (old Ch11), Mineral Nutrition (old Ch12), Digestion & Absorption (old Ch16)
 * Biology 12: Reproduction in Organisms (old Ch1), Strategies for Enhancement (old Ch9), Environmental Issues (old Ch16)
 * Physics 11: Physical World (old Ch1) — remaining chapters renumbered from Ch1
 */
...
export const NCERT_BOOKS = [
    ...
    // ═══════════════════════════════════════════════
    {
        ...
        chapters: [
            ...
            { ch: 5, title: 'Thermodynamics' },
            { ch: 6, title: 'Equilibrium' },
        ]
    },
    {
        ...
        chapters: [
            ...
            { ch: 2, title: 'Organic Chemistry: Some Basic Principles and Techniques' },
            { ch: 3, title: 'Hydrocarbons' },
        ]
    },
    // ═══════════════════════════════════════════════
    // CHEMISTRY — Class 12
    // ═══════════════════════════════════════════════
    {
        ...
        chapters: [
            { ch: 1, title: 'Solutions' },
            { ch: 2, title: 'Electrochemistry' },
            { ch: 3, title: 'Chemical Kinetics' },
            { ch: 4, title: 'The d- and f-Block Elements' },
            { ch: 5, title: 'Coordination Compounds' },
        ]
    },
    {
    ...
    // BIOLOGY — Class 12
    // ═══════════════════════════════════════════════
    // RATIONALIZED: Ch1 (Reproduction in Organisms), Ch9 (Strategies for Enhancement),
    // Ch16 (Environmental Issues) deleted. Remaining 13 chapters renumbered.
    {
        subject: 'biology', class: 12, book: 'Biology', code: 'lebo1',
        chapters: [
            { ch: 1, title: 'Sexual Reproduction in Flowering Plants' },
            { ch: 2, title: 'Human Reproduction' },
            { ch: 3, title: 'Reproductive Health' },
            { ch: 4, title: 'Principles of Inheritance and Variation' },
            { ch: 5, title: 'Molecular Basis of Inheritance' },
            { ch: 6, title: 'Evolution' },
            { ch: 7, title: 'Human Health and Diseases' },
            { ch: 8, title: 'Microbes in Human Welfare' },
            { ch: 9, title: 'Biotechnology: Principles and Processes' },
            { ch: 10, title: 'Biotechnology and its Applications' },
            { ch: 11, title: 'Organisms and Populations' },
            { ch: 12, title: 'Ecosystem' },
            { ch: 13, title: 'Biodiversity and Conservation' },
        ]
    },
];
