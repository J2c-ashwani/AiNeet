...
const playSubscriptionProducts = Object.freeze({
    neet_pro_monthly: 'pro',
    neet_premium_monthly: 'premium',
});

const playVerifyBodySchema = z.object({
    purchaseToken: z.string().trim().min(12).max(4096),
    productId: z.enum(Object.keys(playSubscriptionProducts)),
});
