...
const TOPICS = [
    ...
    'Test of Unsaturation of Alkene'
];
...
const QUESTIONS = [
    {
        qNo: 1, topic: 'Preparation of Alkene', year: '2021',
        text: `Dihedral angle of least stable conformer of ethane is: (2021)`,
        A: `180°`, B: `60°`, C: `0°`, D: `120°`
    },
    {
        qNo: 2, topic: 'Chemical Properties of Alkene', year: '2020',
    ...
    {
        qNo: 4, topic: 'Conformations', year: '2018',
        text: `Hydrocarbon (A) reacts with bromine by substitution to form an alkyl bromide which by Wurtz reaction is converted to gaseous hydrocarbon containing less than four carbon atoms. (A) is (2018)`,
        A: `CH ≡ CH`, B: `CH 2 = CH 2`, C: `CH 4`, D: `CH 3 – CH 3`
    },
    {
        qNo: 5, topic: 'Aromatic Hydrocarbon', year: '2017',
    ...
    {
        qNo: 6, topic: 'Chemical Properties of Alkane', year: '2016',
    ...
    {
        qNo: 9, topic: 'Preparation of Alkene', year: '2021',
    ...
    {
        qNo: 10, topic: 'Chemical Properties of Alkene', year: '2020',
    ...
    {
        qNo: 11, topic: 'Preparation of Alkane', year: '2019',
    ...
    {
        qNo: 12, topic: 'Conformations', year: '2016',
    ...
    {
        qNo: 13, topic: 'Aromatic Hydrocarbon', year: '2016',
        text: `The correct structure of the product A formed in the reaction: (2016 - II)`,
        A: `OH`, B: `OH`, C: `OH`, D: `O`
    },
    {
        qNo: 14, topic: 'Chemical Properties of Alkane', year: '2016',
    ...
    {
        qNo: 15, topic: 'Physical Properties of Alkane', year: '2016',
        text: `In which of the following molecules, all atoms are coplanar? (2016 - II)`,
        A: `a. b. c. d.`, B: `Option B`, C: `Option C`, D: `Option D`
    },
    {
        qNo: 16, topic: 'Test of Unsaturation of Alkene', year: '2015 Re',
        text: `In the reaction with HCl, an alkene reacts in accordance with the Markovnikov’s rule, to give a product 1-chloro-1- methylcyclohexane. The possible alkene is: (2015 Re)`,
        A: `CH 2`, B: `CH 3`, C: `(a) and (b)`, D: `CH 3`
    },
    {
    ...
    {
        qNo: 18, topic: 'Chemical Properties of Alkene', year: '2015',
    ...
    {
        qNo: 19, topic: 'Preparation of Alkane', year: '2015',
    ...
    {
        qNo: 21, topic: 'Aromatic Hydrocarbon', year: '2019',
    ...
    {
        qNo: 22, topic: 'Chemical Properties of Alkane', year: '2019',
    ...
    {
        qNo: 23, topic: 'Physical Properties of Alkane', year: '2017',
    ...
    {
        qNo: 24, topic: 'Test of Unsaturation of Alkene', year: '2017',
    ...
    {
        qNo: 25, topic: 'Preparation of Alkene', year: '2016',
    ...
    {
        qNo: 30, topic: 'Chemical Properties of Alkane', year: '2019',
        text: `Among the following, the reaction that proceeds through an electrophilic substitution, is: (2019)`,
        A: `a. b. c. d.`, B: `Option B`, C: `Option C`, D: `Option D`
    },
    {
        qNo: 31, topic: 'Physical Properties of Alkane', year: '2018',
    ...
    {
        qNo: 32, topic: 'Test of Unsaturation of Alkene', year: '2016',
    ...
    {
        qNo: 35, topic: 'Preparation of Alkane', year: '2013',
    ...
    {
        qNo: 36, topic: 'Conformations', year: '2013',
