...
const QUESTIONS = [
    ...
    {
        qNo: 10, topic: 'General', year: '2013',
    ...
    {
        qNo: 11, topic: 'General', year: '2022',
    ...
    {
        qNo: 13, topic: 'General', year: '2019',
    ...
    {
        qNo: 22, topic: 'General', year: '2017',
    ...
    {
        qNo: 27, topic: 'General', year: '2014',
    ...
    {
        qNo: 28, topic: 'General', year: '2013',
