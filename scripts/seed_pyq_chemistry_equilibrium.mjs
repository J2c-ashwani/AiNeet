...
const TOPICS = [
    ...
    'Relationship Between K, Q and Gibbs Free Energy',
    'Different Theory For Acid And Base',
    'pH Calculation',
    'Application of Equilibrium Constant',
    'Equilibrium Constant of Various Equilibrium',
...
const QUESTIONS = [
    ...
    {
        qNo: 2, topic: 'Relationship Between K, Q and Gibbs Free Energy', year: '2017',
    ...
    {
        qNo: 3, topic: 'Different Theory For Acid And Base', year: '2015 Re',
    ...
    {
        qNo: 5, topic: 'Application of Equilibrium Constant', year: '2020',
    ...
    {
        qNo: 6, topic: 'Equilibrium Constant of Various Equilibrium', year: '2018',
    ...
    {
        qNo: 7, topic: 'Le Chatelier\'s Principle', year: '2017',
    ...
    {
        qNo: 8, topic: 'Solubility and Solubility Product', year: '2017',
    ...
    {
        qNo: 9, topic: 'Relationship Between K, Q and Gibbs Free Energy', year: '2016',
    ...
    {
        qNo: 10, topic: 'Different Theory For Acid And Base', year: '2015',
    ...
    {
        qNo: 11, topic: 'pH Calculation', year: '2014',
    ...
    {
        qNo: 12, topic: 'Application of Equilibrium Constant', year: '2014',
    ...
    {
        qNo: 13, topic: 'Equilibrium Constant of Various Equilibrium', year: '2013',
    ...
    {
        qNo: 14, topic: 'Le Chatelier\'s Principle', year: '2019',
    ...
    {
        qNo: 15, topic: 'Solubility and Solubility Product', year: '2016',
    ...
    {
        qNo: 16, topic: 'Relationship Between K, Q and Gibbs Free Energy', year: '2013',
    ...
    {
        qNo: 17, topic: 'Different Theory For Acid And Base', year: '2021',
    ...
    {
        qNo: 18, topic: 'pH Calculation', year: '2020',
    ...
    {
        qNo: 19, topic: 'Application of Equilibrium Constant', year: '2018',
    ...
    {
        qNo: 20, topic: 'Equilibrium Constant of Various Equilibrium', year: '2016',
    ...
    {
        qNo: 21, topic: 'Le Chatelier\'s Principle', year: '2015 Re',
    ...
    {
        qNo: 22, topic: 'Solubility and Solubility Product', year: '2015 Re',
    ...
    {
        qNo: 23, topic: 'Relationship Between K, Q and Gibbs Free Energy', year: '2014',
        text: `Which of the following salts will give highest pH in water? (2014)`,
        A: `NaCl`, B: `Na 2 CO 3`, C: `CuSO 4`, D: `KCl Buffer Solutions`
    },
    {
        qNo: 24, topic: 'Different Theory For Acid And Base', year: '2022',
    ...
    {
        qNo: 25, topic: 'pH Calculation', year: '2019',
    ...
    {
        qNo: 26, topic: 'Application of Equilibrium Constant', year: '2015 Re',
    ...
    {
        qNo: 27, topic: 'Equilibrium Constant of Various Equilibrium', year: '2020',
    ...
    {
        qNo: 28, topic: 'Le Chatelier\'s Principle', year: '2020',
    ...
    {
        qNo: 29, topic: 'Solubility and Solubility Product', year: '2020',
    ...
    {
        qNo: 30, topic: 'Relationship Between K, Q and Gibbs Free Energy', year: '2020',
        text: `pH of a saturated solution of Ca(OH 2 ) is`,
        A: `Option A`, B: `Option B`, C: `Option C`, D: `Option D`
    },
    {
        qNo: 31, topic: 'Different Theory For Acid And Base', year: '2019',
        text: `The solubility product (K sp ) of Ca(OH) 2 is: (2019)`,
        A: `0.5 × 10 –15`, B: `0.25 × 10 –10`, C: `0.125 × 10 –15`, D: `0.5 × 10 –10`
    },
    {
        qNo: 32, topic: 'pH Calculation', year: '2018',
    ...
    {
        qNo: 33, topic: 'Application of Equilibrium Constant', year: '2017',
    ...
    {
        qNo: 34, topic: 'Equilibrium Constant of Various Equilibrium', year: '2016',
    ...
    {
        qNo: 37, topic: 'Relationship Between K, Q and Gibbs Free Energy', year: '2014',
    ...
    {
        qNo: 38, topic: 'Different Theory For Acid And Base', year: '2013',
