...
const QUESTIONS = [
    ...
    {
        qNo: 4, topic: 'Nomenclature', year: '2015 Re',
    ...
    {
        qNo: 5, topic: 'Isomerism', year: '2022',
    ...
    {
        qNo: 6, topic: 'Werner\'s Theory', year: '2018',
    ...
    {
        qNo: 7, topic: 'Ligand Field Theory', year: '2015 Re',
    ...
    {
        qNo: 8, topic: 'Chelation and Denticity', year: '2015 Re',
    ...
    {
        qNo: 9, topic: 'Magnetism', year: '2022',
    ...
    {
        qNo: 10, topic: 'Nomenclature', year: '2021',
        text: `Match List-I with List-II. (2021) List-I List-II`,
        A: `[Fe(CN) 6 ] 3– (i) 5.92 BM`, B: `[Fe(H 2 O) 6 ] 3+ (ii) 0 BM`, C: `[Fe(CN) 6 ] 4– (iii) 4.90 BM`, D: `[Fe(H 2 O) 6 ] 2+ (iv) 1.73 BM Choose the correct answer from the options given below. a. A-ii B-iv C-iii D-i b. A-i B-iii C-iv D-ii c. A-iv B-i C-ii D-iii d. A-iv B-ii C-i D-iii 6 C H A P T E R Coordination Compounds Coordination Compounds 2`
    },
    {
        qNo: 11, topic: 'Isomerism', year: '2020',
    ...
    {
        qNo: 12, topic: 'Werner\'s Theory', year: '2020',
        text: `Match the coordination number and type of hybridisation with distribution of hybrid orbitals in space based on Valence bond theory. (2020-Covid) Coordination number and type of hybridisation Distribution of hybrid orbit- als in space`,
        A: `4, sp 3 (i) Trigonal bipyramidal`, B: `4, dsp 2 (ii) Octahedral`, C: `5, sp 3 d (iii) Tetrahedral`, D: `6, d 2 sp 3 (iv) Square planar Select the correct option: a. A-iii B-iv C-i D-ii b. A-iv B-i C-ii D-iii c. A-iii B-i C-iv D-ii d. A-ii B-iii C-iv D-i`
    },
    {
        qNo: 13, topic: 'Ligand Field Theory', year: '2019',
    ...
    {
        qNo: 14, topic: 'Chelation and Denticity', year: '2018',
    ...
    {
        qNo: 15, topic: 'Magnetism', year: '2017',
    ...
    {
        qNo: 16, topic: 'Nomenclature', year: '2017',
    ...
    {
        qNo: 17, topic: 'Isomerism', year: '2016',
    ...
    {
        qNo: 21, topic: 'Magnetism', year: '2014',
    ...
    {
        qNo: 22, topic: 'Nomenclature', year: '2013',
    ...
    {
        qNo: 25, topic: 'Ligand Field Theory', year: '2014',
